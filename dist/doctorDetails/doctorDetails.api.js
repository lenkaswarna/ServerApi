        ...
        value: function configureRoutes() {
            ...
            this.app.put('/api/doctorDetails/:id', function (req, res) {
                _this.fs.readFile(_this.dataFile, function (err, data) {
                    ...
                    var doctorrDetails = JSON.parse(data);
                    var idIndex = 0;
                    ...
                    findDoctorDetailById[0].briefDescription = req.body.briefDescription;
                    findDoctorDetailById[0].speciality = req.body.speciality;
                    findDoctorDetailById[0].speciality = req.body.speciality;
                    findDoctorDetailById[0].experience = req.body.experience;
                    findDoctorDetailById[0].description = req.body.description;
                    ...
                    doctorDetails.splice(idIndex, 1, findDoctorDetailsById[0]);
                    _this.fs.writeFile(_this.dataFile, JSON.stringify(doctorDetails, null, 4), function (err) {
                        if (err) {
                            console.error(err);
                            process.exit(1);
